...
const Depth1Frame11 = ({
  ...
  const depth3Frame21Style = useMemo(() => {
    return {
      ...getStyleValue("width", propWidth),
    };
  }, [propWidth]);

  const depth4Frame02Style = useMemo(() => {
    return {
      ...getStyleValue("width", propWidth1),
    };
  }, [propWidth1]);

  const depth4Frame14Style = useMemo(() => {
    return {
    ...
    <View style={styles.depth1Frame2}>
      <View style={styles.depth2Frame0}>
        <Image
          ...
          source={depth3Frame0}
        />
        <View style={[styles.depth3Frame2, depth3Frame21Style]}>
          <View style={[styles.depth4Frame0, depth4Frame02Style]}>
            <View style={styles.depth5Frame0}>
              <Text style={styles.projectWithAnna}>{projectWithAnna}</Text>
            </View>
          </View>
          <View style={[styles.depth4Frame1, depth4Frame14Style]}>
            <View style={styles.depth5Frame0}>
