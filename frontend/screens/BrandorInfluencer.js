  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.termsContainer}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate("TosPrivacyPolicy",{type:"tos",navigate:"BrandorInfluencer"})}>
          <Text style={styles.linkText}>Terms of Service</Text>
        </TouchableOpacity>
        <Text style={styles.termsText}> and </Text>
        <TouchableOpacity onPress={()=>navigation.navigate("TosPrivacyPolicy",{type:"pp",navigate:"BrandorInfluencer"})}>
