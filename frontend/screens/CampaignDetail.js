    ...
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.shareIcon}>
          <Image style={styles.icon} source={require('../assets/depth-5-frame-12.png')} />
        </TouchableOpacity>
      </View>
      <Image style={styles.mainImage} source={require('../assets/depth-4-frame-12.png')} />
      ...
      <View style={styles.requirement}>
        <Image style={styles.icon} source={require('../assets/depth-5-frame-11.png')} />
      ...
      <View style={styles.requirement}>
        <Image style={styles.icon} source={require('../assets/depth-4-frame-13.png')} />
        <View style={styles.textContainer}>
